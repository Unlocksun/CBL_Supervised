...
function [DeepMIMO_dataset,params]=I2_gen()
...
params.active_user_last=700;        % The last row of the considered receivers section (check the scenario description for the receiver row map)
