...
function [DeepMIMO_dataset,params]=O1_gen()
...
% Active users
params.active_user_first=800;       % The first row of the considered receivers section (check the scenario description for the receiver row map)
params.active_user_last=1200;        % The last row of the considered receivers section (check the scenario description for the receiver row map)
